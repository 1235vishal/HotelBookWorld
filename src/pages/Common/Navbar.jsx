...
//             <button className="px-4 py-2 rounded-lg font-semibold text-slate-700 hover:text-slate-900">
//               Login
//             </button>
//             <Link
//               to="/search"
...
//             <button className="flex-1 px-4 py-2 rounded-lg font-semibold text-slate-700 bg-slate-100">
//               Login
//             </button>
//             <Link
//               to="/search"
