...
/**
 * Reset
 * Reset Password page matching the Login layout (no logo on the right).
 * - Left: rounded image frame with 4-slide carousel + dots
 * - Right: card with New Password + Confirm Password (with visibility toggles)
 * - Theme color: #F17232 (configurable via themeColor)
 *
 * Props:
 * - themeColor?: string                               // default "#F17232"
 * - slides?: string[]                                 // optional image URLs for carousel
 * - rotateIntervalMs?: number                         // default 5000
 * - onReset?: (payload: { password: string }) => void // callback on submit
 */
export default function Reset({
  ...
  const handleSubmit = (e) => {
    ...
    if (onReset) onReset({ password });
      ...
      alert("Password reset (demo). Implement your flow.");
    }
  };
